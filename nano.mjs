...
export const paymentRequest = nano.paymentRequest.bind(nano);
export const getPaymentStatus = nano.getPaymentStatus.bind(nano);
export const monitorPayment = nano.monitorPayment.bind(nano);
